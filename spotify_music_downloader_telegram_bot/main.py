...
def main() -> None:
	if Functions.if_find_folder_or_file('./data', 'spotify_music_downloader_telegram_bot.token') is False:
...
if __name__ == '__main__':
	...
	logging.basicConfig(filename='./data/spotify_music_downloader_telegram_bot.log', filemode='w', format='[%(asctime)s]: %(levelname)s > %(message)s', level=logging.INFO)
